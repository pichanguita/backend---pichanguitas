...
const amenitiesCatalogRoutes = require('./routes/amenitiesCatalogRoutes');
const videoTutorialsRoutes = require('./routes/videoTutorialsRoutes');
...
app.use('/api/amenities-catalog', amenitiesCatalogRoutes);
